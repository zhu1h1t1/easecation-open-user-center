...
const MainLayout = () => {
    ...
    const breadcrumbItems = [
        ...
        ...pathSnippets
            .map((_snippet, index) => {
                ...
                // For users without authorize.normal permission, replace /admin with /admin/utility-tools
                if (
                    !hasAdminPermission &&
                    url === '/admin' &&
                    location.pathname.startsWith('/admin')
                ) {
                    url = '/admin/utility-tools';
                }
    ...
    const handleLogout = async () => {
        try {
            ...
            // 显示成功消息
            messageApi.success(gLang('mainLayout.logoutSuccess'));
