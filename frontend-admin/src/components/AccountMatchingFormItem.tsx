    ...
    const inputRules = [
        ...
        ...(required
            ? [
                  {
                      required: true,
                      message: requiredMessage || gLang('form.requiredField'),
                  },
              ]
            : []),
        {
            validator: (_: any, value: any) => {
                ...
                if (chooseFieldName && chooseRequired && !form.getFieldValue(chooseFieldName)) {
                    return Promise.reject(
                        chooseRequiredMessage || gLang('form.selectUserFromDropdown')
                    );
                }
                ...
                if (
                    ...
                    return Promise.reject(gLang('form.userNotFound'));
                }
    ...
    const selectRules = [
        ...
        ...(chooseRequired
            ? [
                  {
                      required: true,
                      message: chooseRequiredMessage || gLang('form.selectUser'),
                  },
              ]
            : []),
    ];
                ...
                >
                    ...
                    >
                        {accountMatching.availableUsers.map(user => (
                            <Option key={user.ecid} value={user.ecid}>
